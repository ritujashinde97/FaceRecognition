...
face_classifier = cv2.CascadeClassifier("C:/Users/Rituja/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml")
...
while True:
    ...
    try:
        ...
        if confidence > 75 :
            ...
            cv2.putText(image, "Locked", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 2550))
            cv2.imshow('Face Cropper', image)
